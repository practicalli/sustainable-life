...
!!! INFO "Store in the refrigerator for up to 1 month"

!!! WARNING "Avoid turnips with brown, soft spots"
...
![Pink Pickled Turnips](https://github.com/practicalli/graphic-design/blob/live/sustainable-life/pickles-turnip-jar-fork.png?raw=true){align=right loading=lazy style="width:250px"}
...
!!! TIP "Beetroot can also be eaten"
